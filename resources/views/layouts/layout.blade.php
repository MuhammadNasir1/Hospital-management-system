                    ...
                    @if (session('user_det')['role'] == 'superadmin')
                        <li>
                            <a href="../companies"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Companies')</span>
                            </a>
                        </li>
                        <li>
                            <a href="../requests"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Requests')</span>
                            </a>
                        </li>
                    @endif
                    @if (session('user_det')['role'] == 'admin')
                        <li>
                            <a href="../staff"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Staff')</span>
                            </a>
                        </li>
                        <li>
                            <a href="../departments"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Add_Department')</span>
                            </a>
                        </li>
                    @endif
                    @if (session('user_det')['role'] == 'doctor' || session('user_det')['role'] == 'admin')
                        <li>
                            <a href="../doctor/patients"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Appoinments')</span>
                            </a>
                        </li>
                    @endif
                    @if (session('user_det')['role'] == 'receptionist' || session('user_det')['role'] == 'admin')
                        <li>
                            <a href="../reception/patients"
                                class="mt-3 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg width="20" height="18" viewBox="0 0 20 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Patients')</span>
                            </a>
                        </li>
                    @endif
                    @if (session('user_det')['role'] == 'pharmassist' || session('user_det')['role'] == 'admin')
                        <li>
                            <a href="../pharmacy/create-invoice"
                                class="mt-3 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg width="20" height="18" viewBox="0 0 20 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Create_Invoice')</span>
                            </a>
                        </li>
                        <li>
                            <a href="../pharmacy/inventory"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap"> @lang('lang.Inventory')</span>
                            </a>
                        </li>
                    @endif
                    <li>
